...
__C.DIR.SHAPENET_QUERY_PATH = '/home/sheng/Research/Dataset/ShapeNet/ShapeNetVox32/'
__C.DIR.MODEL_PATH = '/home/sheng/Research/Dataset/ShapeNet/ShapeNetCore.v1/%s/%s/model.obj'
__C.DIR.VOXEL_PATH = '/home/sheng/Research/Dataset/ShapeNet/ShapeNetVox32/%s/%s/model.binvox'
__C.DIR.RENDERING_PATH = '/home/sheng/Research/Dataset/ShapeNet/ShapeNetRendering/%s/%s/rendering'
...
__C.QUEUE_SIZE = 8  # maximum number of minibatches that can be put in a data queue
